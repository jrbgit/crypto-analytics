        ...
        for change in field_changes:
            ...
            try:
                ...
                if result:
                    ...
                    logger.debug(f"Current {field_name}: {current_type}({current_length})")
                
                # Alter the column
                alter_sql = sql.SQL("ALTER TABLE link_content_analysis ALTER COLUMN {} TYPE VARCHAR({})").format(
                    sql.Identifier(field_name),
                    sql.Literal(int(new_size))
                )
