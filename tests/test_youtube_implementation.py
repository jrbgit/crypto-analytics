...
from src.scrapers.youtube_scraper import (
    YouTubeScraper,
    YouTubeVideo,
    YouTubeChannelInfo,
...
class TestYouTubeScraper:
    ...
    def test_video_type_classification(self):
        ...
        other_result = self.scraper.classify_video_type(
            "Random Video Title", "Random description without specific keywords", []
        )
    ...
    def test_scraper_without_api_returns_error_result(self):
        ...
        result = self.scraper.scrape_youtube_channel(
    ...
    def test_calculate_channel_metrics_empty_videos(self):
        ...
        expected_keys = [
            ...
            "subscriber_growth_indicator",
            "content_type_distribution",
            "avg_view_count",
            "avg_engagement_rate",
            "last_upload_date",
            "educational_content_ratio",
    ...
    def test_calculate_channel_metrics_with_videos(self):
        ...
        assert (
            metrics["educational_content_ratio"] == 0.5
        )  # 1 educational out of 2 total
...
class TestYouTubeAnalyzer:
    ...
    def test_format_analysis_for_storage(self):
        ...
        assert json.loads(formatted["primary_content_types"]) == [
            "educational",
            "technical",
        ]
