...
def test_url_filtering():
    ...
    print("\n" + "=" * 50)
    print(
        f"📊 Results: {len(results['filtered'])} filtered, {len(results['allowed'])} allowed"
    )
...
def test_content_filtering():
    ...
    test_content = [
        ...
        (
            "Welcome to our cryptocurrency project. We are building the future of finance with blockchain technology.",
            False,
        ),
        (
            "About us: Founded in 2020, we are developing decentralized finance solutions.",
            False,
        ),
        ("", False),  # Empty content
        ...
        (
            "This domain provides cryptocurrency news and analysis for the blockchain community.",
            False,
        ),  # Contains "domain" but legitimate
    ]
