...
def wipe_database_direct():
    ...
    logger.info(f"Connecting to database: {database_url.split('@')[1] if '@' in database_url else 'local database'}")
    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            tables = ['crypto_projects', 'project_links', 'project_images', 'project_changes', 'api_usage', 'link_content_analysis', 'project_analysis']
