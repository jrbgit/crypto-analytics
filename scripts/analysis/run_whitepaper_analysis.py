...
def main():
    ...
    whitepaper_projects = pipeline.discover_projects_for_analysis(
        link_types=["whitepaper"]
    )
    ...
    stats = pipeline.run_analysis_batch(
        link_types=["whitepaper"], max_projects=batch_size
    )
