...
def check_python_version():
    ...
    if version.major == 3 and version.minor >= 10:
        ...
        print(
            f"❌ Python {version.major}.{version.minor}.{version.micro} is not compatible. Requires Python 3.10+"
        )
        return False
...
def main():
    ...
    if setup_environment():
        ...
        print(
            "  3. Run: python scripts/analysis/monitor_progress.py (to check system status)"
        )
